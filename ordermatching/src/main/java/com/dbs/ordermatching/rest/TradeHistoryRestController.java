...
public class TradeHistoryRestController {
	...
	public ResponseEntity<Object> getTradeHistoryByCustodian(@PathVariable String custodianid){
		List<TradeHistory> l=thservice.getTradeHistoryByCustodian(custodianid);
		if(l.size()>0)
